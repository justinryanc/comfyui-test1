...
Submission: https://comfy.getrunpod.io/dashboard/submissions/kd70tmwnd9an7sqfj26v5xs5nh87c8j1
## Pull the prebuilt image

We've already built and published this image on Docker Hub:

```bash
docker pull timpietruskyrunpod/comfyui-wizard:kd70tmwnd9an7sqfj26v5xs5nh87c8j1
docker run --rm --gpus all -p 8188:8188 timpietruskyrunpod/comfyui-wizard:kd70tmwnd9an7sqfj26v5xs5nh87c8j1
```
